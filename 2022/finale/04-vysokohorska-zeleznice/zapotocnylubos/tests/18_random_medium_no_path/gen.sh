...
# while [ -s tests/18_random_medium_no_path/out.txt ] || [ ! -f tests/18_random_medium_no_path/out.txt ]; do cd tests/18_random_medium_no_path && ./gen.sh && cd ../../ && ./solution <tests/18_random_medium_no_path/in.txt >tests/18_random_medium_no_path/out.txt; done
