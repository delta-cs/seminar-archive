...
Na vstupu programu bude jedno celé číslo (od 0 do 1 000 000 000).

Úkolem je vypsat rozklad tohoto čísla na mocniny čísla 10 (jednotky, desítky, stovky…). Rozklad bude na jednotlivých
řádcích od nejvyšší po nejnižší mocninu a ve formátu `n x d`, kde `n` je násobek a `d` je mocnina 10. Když je násobek 0,
